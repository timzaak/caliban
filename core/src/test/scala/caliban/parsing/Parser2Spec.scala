...
object Parser2Spec extends DefaultRunnableSpec {
...
//      },
      testM("type") {
        val gqltype =
          """type Hero {
            ...
            |powers: [String!]!
            |}""".stripMargin
        assertM(Parser2.parseQuery(gqltype))(
          equalTo(
            Document(
              List(
      ...
      testM("extend schema with directives") {
        ...
        assertM(Parser2.parseQuery(gqlSchemaExtension))(
          equalTo(
            Document(
              List(
                SchemaExtension(
      ...
      testM("extend scalar with directives") {
        ...
        assertM(Parser2.parseQuery(gqlScalarExtension))(
          equalTo(
            Document(
              List(
                ScalarTypeExtension(
      ...
      testM("extend type with interfaces") {
        ...
        assertM(Parser2.parseQuery(gqlTypeExtension))(
          equalTo(
            Document(
              List(
                ObjectTypeExtension(
      ...
      testM("extend interface with directives") {
        ...
        assertM(Parser2.parseQuery(gqlInterfaceExtension))(
          equalTo(
            Document(
              List(
      ...
      testM("extend union with directives") {
        ...
        assertM(Parser2.parseQuery(gqlUnionExtension))(
          equalTo(
            Document(
              List(
                UnionTypeExtension(
      ...
      testM("extend enum with directives") {
        ...
        assertM(Parser2.parseQuery(gqlEnumExtension))(
          equalTo(
            Document(
              List(
                EnumTypeExtension(
      ...
      testM("extend input with directives") {
        ...
        assertM(Parser2.parseQuery(gqlInputExtension))(
          equalTo(
            Document(
              List(
